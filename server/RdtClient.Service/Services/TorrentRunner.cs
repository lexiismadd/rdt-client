...
public string ExtractSeriesNameFromRdName(string rdName, string category)
{
    ...
    if (string.IsNullOrEmpty(seriesName))
    {
        ...
        if (string.IsNullOrEmpty(seriesName))
        {
            seriesName = ExtractSeriesNameFromNumber(rdName);
        }
    }
...
private string ExtractSeriesNameFromCrochet(string rdName)
{
    if (string.IsNullOrWhiteSpace(rdName))
    {
        return null;
...
private string ExtractSeriesNameFromNumber(string rdName)
{
    if (string.IsNullOrWhiteSpace(rdName))
    {
        _logger.LogError("Le nom du fichier est vide ou null.");
